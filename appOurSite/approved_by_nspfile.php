...
student_status_data.student_id,students.ifsc_code,students.account_number,students.account_balance,students.transcation,students.dob,
students.credit_amount,students.bankstatus,student_status_data.student_status,students.withdraw
FROM students  
LEFT JOIN student_status_data
ON students.student_id=student_status_data.student_id 
WHERE student_status='approved_by_our_site' ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
