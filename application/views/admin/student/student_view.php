    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <a href="<?php echo base_url('admin/student/all_student_list') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> All Students
                </a>
            </div>
                        ...
                        <div class="white-box">
                            ...
                            <div id="image-popups" class="row">
                                ...
                                <div class="col-sm-3 mb-5">
                                    <a href="/<?php
                                                echo $user->ac_back;
                                                ?>" data-effect="mfp-3d-unfold" title="Aadhar Back">
