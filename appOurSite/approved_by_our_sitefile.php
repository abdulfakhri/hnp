...
$sel = mysqli_query($con,"select count(*) as allcount FROM students  
    ...
    WHERE student_status='approved_by_our_site' ".$searchQuery);
$records = mysqli_fetch_assoc($sel);
...
$empQuery = "SELECT students.bnk_acnt_number,students.dob,students.tr_number,students.full_name,student_status_data.student_id,students.mobile,students.course_details,students.agent_name,students.remarks,
...
LEFT JOIN student_status_data
ON students.student_id=student_status_data.student_id 
WHERE student_status='nsp_reject' ".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
