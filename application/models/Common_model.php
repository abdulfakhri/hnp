...
class Common_model extends CI_Model
{
    ...
    function total_students_collegesite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function total_students_nspsite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function pending_students_oursite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function pending_students_nspsite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function reject_students_oursite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function reject_students_collegesite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
    ...
    function reject_students_nspsite()
    {
        $this->db->select('*');
        $this->db->from('students');
        $this->db->where('is_deleted IS NULL or is_deleted <> 1');
        $this->db->where('student_status', 'rejected_by_nsp');
        $query = $this->db->get();
        $query = $query->result_array();
        return $query;
    }
    ...
    */
    ...
    {
        $this->db->select('*');
        //$this->db->from('user WHERE is_deleted=1');
        $this->db->where('is_deleted', 1);
        //$this->db->where('is_deleted IS NOT NULL');
        $query = $this->db->get();
        $query = $query->result_array();
        return $query;
    }
...
*/
    ...
    function upload_image($max_size, $fieldName)
    {
        ...
        $config['max_size']     = '9200';
        $config['max_width']    = '9200';
