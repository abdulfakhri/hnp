                                ...
                                <tr data-class="<?= $chekVal; ?>">
                                    ...
                                    <?php if ($this->session->userdata('role') == 'admin') { ?>
                                        <td class="icon_action">
                                            ...
                                            <a href="<?php echo base_url('admin/student/stu_delete/' . $user['student_id']); ?>" data-toggle="tooltip" onclick="return confirm('Are you sure that you want to delete this student?')" data-original-title="Delete">
                                                <button type="button" class="btn btn-danger btn-circle btn-xs">
                                                    <i class="fa fa-trash-o"></i>
                                                </button>
                                            </a>
                                            <a href="<?php echo base_url('admin/student/stu_clone/' . $user['student_id']); ?>" data-toggle="tooltip" onclick="return confirm('Are you sure that you want to copy this student?')" data-original-title="Clone">
                                                <button type="button" class="btn btn-info btn-circle btn-xs">
                                                    <i class="fa fa-clone"></i>
                                                </button>
                                            </a>
                                            <a href="<?php echo base_url('admin/student/student_view_data/' . $user['student_id']); ?>" data-toggle="tooltip" data-original-title="Clone">
                                                <button type="button" class="btn btn-info btn-circle btn-xs">
                                                    View
                                                </button>
                                            </a>
                                            <a href="<?php echo base_url('admin/student/update/' . $user['student_id']); ?>" data-toggle="tooltip" data-original-title="Clone">
                                                <button type="button" class="btn btn-info btn-circle btn-xs">
                                                    Edit
                                                </button>
                                            </a>
                                ...
                                <tr data-class="<?= $chekVal; ?>">
                                    ...
                                    <?php if ($this->session->userdata('role') == 'admin') { ?>
                                        <td class="icon_action">
                                            ...
                                            <a href="<?php echo base_url('admin/student/stu_delete/' . $user['student_id']); ?>" data-toggle="tooltip" data-original-title="Delete">
                                                <button type="button" class="btn btn-danger btn-circle btn-xs">
                                                    <i class="fa fa-trash-o"></i>
                                                </button>
                                            </a>
                                            <a href="<?php echo base_url('admin/student/stu_clone/' . $user['student_id']); ?>" data-toggle="tooltip" data-original-title="Clone">
                                                <button type="button" class="btn btn-info btn-circle btn-xs">
                                                    <i class="fa fa-clone"></i>
                                                </button>
                                            </a>
