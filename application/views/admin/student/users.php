...
?>
           ...
           <div class="panel panel-info">
                <div class="panel-heading"> <i class="fa fa-list"></i> All Users
				 ...
				 <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <a href="<?php echo base_url('admin/student') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp;New Student</a> &nbsp;
            ...
            <?php endif ?>
							<table id="example23" class="display nowrap dataTable" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
                            ...
                            <?php foreach ($users as $user): ?>
                                ...
                                foreach ($unserlizedData as $stuData) { ?> 
                                <tr>

                                    <td><?php echo $stuData['first_name'].' '.$stuData['last_name']; ?></td>
                                    <td><?php echo $stuData['email']; ?></td>
                                    <td><?php echo $stuData['mobile']; ?></td>
                                    <?php //foreach ($country as $key => $value) {
                                       //if($value['id'] == $stuData['country'] && $value['status'] == 1 ){ ?>
                                   ...
                                   <!--  <td width="10%">
                                    ...
                                    <td class="text-nowrap">
										...
										<a href="<?php echo base_url('admin/user/update/'.$user['student_id']) ?>"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></button></a>
																				
											<a href="<?php echo base_url('admin/user/delete/'.$user['student_id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a> 
 ...
 <a href="<?php echo base_url('admin/user/update/'.$user['student_id']) ?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></button></a> 
