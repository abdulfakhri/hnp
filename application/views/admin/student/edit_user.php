                               ...
                               <select class="form-control custom-select" name="state" aria-invalid="false" required>
                                  <option disabled value="0">Select</option>
                                    <?php foreach ($states as $st_keys=>$st_values): ?>
                                    	<option <?php if($st_values == $userData->state){  echo 'selected="selected"';} ?> value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option>
                               ...
                               <select class="form-control custom-select" name="caste_details" aria-invalid="false" required>
                                    <option disabled value="0">Select</option>
                                      <?php foreach ($caste as $st_keys=>$st_values): ?>
                                            <!-- <option value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option> -->
                                            <option <?php if($st_values == $userData->caste_details){  echo 'selected="selected"';} ?> value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option>
                                      <?php endforeach ?>
                              </select>
                        ...
                        <select class="form-control custom-select" name="course_details" aria-invalid="false">
                                  <option disabled value="0">Select</option>
                                    <?php foreach ($course as $st_keys=>$st_values): ?>
                                          <!-- <option value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option> -->
                                          <option <?php if($st_values == $userData->course_details){  echo 'selected="selected"';} ?> value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option>
                              ...
                              <select class="form-control custom-select bank_name_section" name="bank_name" aria-invalid="false">
                                  <option disabled value="0">Select</option>
                                    <?php foreach ($banks as $st_keys=>$st_values): ?>
                                    	 <option <?php if($st_values == $userData->bank_name){  echo 'selected="selected"';} ?> value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option>
                                          <!-- <option value="<?php echo $st_keys ?>"><?php echo $st_values; ?></option> -->
                                    <?php endforeach ?>
                            </select>
                        </div>
                   ...
                   <div class="col-sm-4 ol-md-4 col-xs-12">
                     ...
                     <div class="col-sm-4 ol-md-4 col-xs-12">
                            <div class="white-box">
                                ...
                                <input type="file" id="ac_back" name="ac_back" class="dropify" data-max-file-size="2M"  data-show-remove="false" 
                                data-default-file="/<?php echo $ac_back['0'] ?>" />
