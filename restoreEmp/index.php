 ...
 <body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><h3 style="color:white">Restore Deleted Employees</h3></li>
...
<h1>
  ...
  <div class="container box">
   ...
   <div class="table-responsive">
    ...
    <div align="left">
  <!--  <button type="button" name="delete_all" id="delete_all" onclick="myFunction()" class="btn btn-danger btn-xs">Restore Selected</button>-->
    </div>
    <br />
