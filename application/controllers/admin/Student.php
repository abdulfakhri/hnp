...
class Student extends CI_Controller
{
    ...
    public function deleted_students()
    {
        ...
        $data['users'] = $this->common_model->get_deleted_students();
    ...
    public function total_students_our_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->total_students_oursite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function total_students_college_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->total_students_collegesite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function total_students_nsp_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->total_students_nspsite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function pending_students_nsp_site()
    {
        ...
        $data['assignedTaskListPending'] =  $this->common_model->get_EmployeeWith_Allstudents_Pending($current_EmpId, 'emp_task_assigned');
        $data['assignedTaskListComplete'] =  $this->common_model->get_EmployeeWith_Allstudents_Completed($current_EmpId, 'emp_task_assigned');
        $data['main_content'] = $this->load->view('admin/student/pending_by_nsp_site', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function defect_students_our_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->defect_students_oursite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function defect_students_college_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->defect_students_collegesite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function defect_students_nsp_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->defect_students_nspsite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function reject_students_our_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->reject_students_oursite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function reject_students_college_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->reject_students_collegesite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function reject_students_nsp_site()
    {
        ...
        $data['page_title'] = 'All Registered Students';
        $data['studentFilter'] = 'all';
        $data['users'] = $this->common_model->reject_students_nspsite();
        $data['studentStatus'] = $finalStudentStatus;
        $data['country'] = $this->common_model->select('country');
        $data['count'] = $this->common_model->get_user_total();
        $data['assignedTaskList'] =  $this->common_model->get_EmployeeWith_Allstudents($current_EmpId, 'emp_task_assigned');
    ...
    public function update($id){
        ...
        if ($_POST) {
            ...
            $_POST['caste_certi'] =  $prtc['caste_certi'];

            $_POST['ac_front'] =  $ac_front['ac_front'];
